...
class RecipesFakeData: RecipesListDataSource, ObservableObject {
    @Published var dataSource = [ReceipeData]()
    ...
    func add() {
        dataSource.append(MockData().randomRecipe())
